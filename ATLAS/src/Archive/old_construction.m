function [new_S,neighbors,net] = construction(S,init,delta,rho,m,p,t_0,d,load_net)
...
LMDS_debug = false;  %(for debugging) if true for d = D, no LMDS computed
